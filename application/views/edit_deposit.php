...
<head>
    ...
    <script>
        ...
        function validateForm() {
            ...
            if(isValid){
                var cont = confirm ("Would you like to continue editing the deposit entry?");
                if (cont){
                    alert("Deposit entry successfully edited!");
                }else{
                    return false;
                }
            }
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-4 text-center">
            <form method="post" onsubmit="return validateForm();" action="<?php echo base_url();?>deposit/update">
                <?php
                extract($deposit);
                ?>
                <div class="form-group">
                    <label for="employeeName">Employee Name</label>
                    <!--<input type="text" class="form-control" name="employee_username" id="employeeName" value="<?php /*echo $employee_username; */?>"
                                                                           autocomplete="on" />-->
                    <select class="form-control"  name="employee_username" id="employeeName" value="<?php echo $employee_username ?>">
                        <?php foreach ($employee_list as $n_key) { ?>

                            <option value="<?php echo $n_key->username; ?>"   <?php if($n_key->username == $employee_username){echo("selected");}?> ><?php echo $n_key->username; ?></option>
                ...
                <div class="form-group">
                    <label for="voucherNumber">Disbursement Voucher Number</label> <input
                        ...
                        id="voucherNumber" name="disbursement_voucher_number" value="<?php echo $disbursement_voucher_number; ?>"/>
                ...
                <div class="form-group">
                    <label for="amount">Amount (in Pesos)</label> <input type="text"
                                                                         id="amount" class="form-control"  name="amount" value="<?php echo $amount; ?>" />
                ...
                <div class="form-group">
                    <label for="dateOfDeposit">Date of Deposit</label> <input
                        type="date" id="dateOfDeposit" class="form-control" name="deposit_date" value="<?php echo $deposit_date; ?>"
                        />
                ...
                <div class="form-group">
                    <label for="bankAccount">Bank Account Number</label> <input
                        type="text" id="bankAccount" class="form-control" name="bank_account" value="<?php echo $bank_account; ?>"
                        />
                ...
                <button type="submit" class="btn btn-teal">Edit Deposit
                    Entry</button>
